...
// Exercises - Manage editing exercises
export const FETCH_EDIT_EXERCISE = "FETCH_EDIT_EXERCISE" as const;
export const LOAD_EDIT_EXERCISE = "LOAD_EDIT_EXERCISE" as const;
...
// Gym Photos - Fetch and manage gym photos
